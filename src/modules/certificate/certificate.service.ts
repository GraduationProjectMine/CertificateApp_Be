...
export class CertificateService {
  ...
  async issueFromTemplateSingle(
    ...
    const ipfsPayload = {
      ...
      headOfOrganization: dto.headOfOrganization,
      organization_name: dto.organization_name || organization.organization_name,
      organization_logo: dto.organization_logo,
      template_id: dto.template_id,
